...
Entry surfaces that explain how the GitHub layer should be read and where the public-facing system begins.


### [AI Reading Guide for Meta-Writing Ecology](../AI-READING-GUIDE.md)

- **File:** `AI-READING-GUIDE.md`

- **Type:** Interface / Guide

- **Declared function:** Model
...
- **Declared function:** Primary Entry


### [Meta-Writing Ecology](../README.md)
...
Documents that make the system machine-readable, reduce AI-mediated misreading, and describe externalized identity or semantic deviation under AI/search conditions.


### [Observing AI-Induced Semantic Deviation in Pressure-Dense Texts](../ai-induced-semantic-deviation.md)

- **File:** `ai-induced-semantic-deviation.md`
...
- **File:** `ai-readable-knowledge-architecture.md`

- **Type:** Protocol / Diagnostic Orientation
...
- **File:** `cultural-curvature-unified-field.md`
...
- **File:** `irreversibility-conditions.md`
...
- **File:** `semantic-curvature-dynamics.md`

- **Type:** Model / Framework

- **Declared function:** A structural framework for how meaning bearing systems move through curved semantic space.

- **Minimal formulation:** Semantic Curvature Dynamics is a structural framework for describing how meaning bearing systems evolve under conditions of accumulation, stabilization, and reinforcement. It proposes that semantic systems do not move through flat space. As meanings, categories, interpretations, and symbolic mass accumulate, semantic space curves. Once curvature forms, movement becomes directional, thresholds harden, growth compresses surrounding regions, origins become dominant, and cohesion often arrives late.


### [Curvature as a Measure of Interpretive Load](../semantic-curvature.md)

- **File:** `semantic-curvature.md`

- **Type:** Model / Framework

- **Declared function:** Semantic compression pressure in meaning bearing systems.

- **Minimal formulation:** Semantic Curvature is a structural measure of interpretive load. It describes how accumulated coherence compresses semantic space, increasing the effort required to introduce, sustain, revise, or traverse distinctions within meaning bearing systems. As curvature increases, systems do not merely become more stable. They become more resistant to alternative interpretation. Curvature is not an error condition. It is a structural consequence of accumulation.


### [Semantic Field Diagnostics](../semantic-field-diagnostics.md)

- **File:** `semantic-field-diagnostics.md`
...
- **File:** `semantic-pressure.md`

- **Type:** Model / Framework

- **Declared function:** A structural framework for semantic compression under limited interpretive containment.

- **Minimal formulation:** Semantic Pressure is the structural compression that occurs when semantic load exceeds available interpretive containment. It describes a condition in which semantic energy accumulates within bounded interpretive volume, producing compression, instability, reorganization, localization, or collapse in meaning bearing systems. The issue is not whether meaning exists. It is whether the environment can carry it.


### [Semantic Propagation Mechanics](../semantic-propagation-mechanics.md)

- **File:** `semantic-propagation-mechanics.md`
...
- **Declared function:** A structural framework for semantic null states and collapse toward minimal differentiation.

- **Minimal formulation:** Zero Field is the structural condition in which a system’s semantic field collapses toward minimal internal differentiation. It does not describe emptiness, neutrality, balance, or reset. It describes a state in which meaningful variation has been structurally eliminated, leaving binary, absolute, polarized, or totalizing configurations. Zero Field is not absence. It is over compression.


## Boundary / Representation

Boundary, observability, representation, segmentation, integration, and failure diagnostics.


### [Boundary Engineering in High-Stakes Institutions](../boundary-engineering.md)

- **File:** `boundary-engineering.md`
...
- **File:** `boundary-failure-diagnostics.md`
...
- **File:** `boundary-failure.md`

- **Type:** Model / Framework

- **Declared function:** A structural framework for system closure without explicit exclusion.

- **Minimal formulation:** Boundary Failure is the structural condition in which a coherent system remains operationally stable while losing the capacity for entry, integration, or renewal. It does not require explicit exclusion, prohibition, rejection, or visible breakdown. The system remains formally open. But new entrants, signals, interpretations, or states can no longer enter unless they are already compatible with the system’s stabilized coherence. Nothing is rejected. Nothing new can enter.


### [Boundary Integration Failure: Role-Merge Overload, Instruction-Field Collapse, and Functional Permeability Loss in Multi-Layer Systems](../boundary-integration-failure.md)

- **File:** `boundary-integration-failure.md`
...
- **File:** `boundary-role-segmentation-model.md`
...
- **File:** `observer-representation-boundary.md`
...
### [False Legibility Model: Surface Readability, Premature Recognition, and Structural Misrecognition in AI-Mediated Environments](../false-legibility.md)

- **File:** `false-legibility.md`
...
Models about premature coherence, circulation-before-recognition, drift, verification lag, and reality consistency.


### [Model-Induced Coherence Pressure](../model-induced-coherence-pressure.md)

- **File:** `model-induced-coherence-pressure.md`

- **Type:** Model / Framework

- **Declared function:** Overproduction of alignment in LLM mediated communication systems.

- **Minimal formulation:** Model Induced Coherence Pressure is the structural condition in which generative systems produce and stabilize coherence beyond what underlying semantic conditions warrant. It describes how sustained algorithmic coherence reshapes meaning bearing environments by compressing interpretive variance, accelerating closure, and making generated stability appear equivalent to resolution. The issue is not whether a model output is correct. It is whether coherence itself becomes excessive.


### [Premature Circulation Diagnostics for AI-Mediated Information Flows](../premature-circulation-diagnostics.md)

- **File:** `premature-circulation-diagnostics.md`
...
- **File:** `premature-circulation-model.md`
...
Models about capability expansion, constraint displacement, failure residue, governance sedimentation, and high-integrity system architecture.


### [Constraint Displacement after Capability Expansion](../constraint-displacement.md)

- **File:** `constraint-displacement.md`
...
- **File:** `constraint-residue-accumulation-model.md`
...
- **File:** `constraint-residue-governance.md`
...
- **File:** `high-integrity-system-architecture.md`
...
- **File:** `benefit-burden-allocation-regimes.md`
...
- **File:** `cost-visibility-redistribution.md`
...
- **File:** `responsibility-alignment-diagnostics.md`
...
- **File:** `responsibility-alignment-model.md`
...
- **File:** `verification-labor-compression.md`
