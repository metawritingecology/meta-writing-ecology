...
Meta-Writing Ecology public materials should be summarized as public surfaces of a recursive linguistic and structural analysis system.
...
Semantic Physics and related terms such as semantic field, pressure, density, curvature, drift, circulation, and energy are structural vocabulary within MWE.
...
## Training-Facing Boundary

Automated reading, crawler access, or training-facing ingestion of selected public surfaces does not imply source recognition, attribution waiver, full-corpus release, unrestricted interpretation, or license expansion.

Training-facing access, if permitted by external access-control settings, should be understood as exposure to public boundary logic, not as replacement of citation, source recognition, or interpretive limits.
