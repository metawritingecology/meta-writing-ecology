...
Status: Public Anchor / Cross-facing Note
Classification: Note
Public Anchor Date: 2026-07-07
Release Level: Anchor-only
Citation Status: Repository citation only
Placement: `public-anchors/external-interface/`
...
This anchor clarifies that the relevant condition is not user rank, personal authorization, or interpretive exclusivity. The relevant condition is whether the boundary distinctions required for Meta-Writing Ecology to remain legible are preserved.
